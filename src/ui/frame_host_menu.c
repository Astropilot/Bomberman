...
static void Init(TFrame* frame)
{
    ...
    TInput *input_serverport = New_TInput(frame, "images/input.png", pos2, color, 5, "Server port");

    SDL_Rect pos_button_play = {(WIN_WIDTH / 2) - (410 / 2), (pos2.y + pos2.h) + 15, 410, 64};
    TButton *btn_play = New_TButton(frame, "images/button_create_normal.png", "images/button_create_hover.png", pos_button_play);
